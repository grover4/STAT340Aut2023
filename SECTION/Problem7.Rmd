...
1. The distribution of age at death of a large population is shown as a density histogram below. The density of each bin (reported as percentages) is given in parentheses above the block. For example, the density of the bin 0-20 is 2.5% or 0.025. 
