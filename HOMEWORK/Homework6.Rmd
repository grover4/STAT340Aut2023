...
b. Using your model in part a, calculate $P(X < 100)$, the probability that fewer than 100 aphids survive. Be sure to do your calculation in a code chunk and then report the answer (rounded to four decimal places) in a complete sentence using inline code.
...
d. Repeat the calculation in part b. using your model from part c. Be sure to do your calculation in a code chunk and then report the answer (rounded to four decimal places) in a complete sentence using inline code.
