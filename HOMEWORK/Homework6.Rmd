...
b. Using your model in part a, calculate $P(X < 10)$, the probability that fewer than 10 aphids survive. Be sure to do your calculation in a code chunk and then report the answer (rounded to four decimal places) in a complete sentence using inline code.
