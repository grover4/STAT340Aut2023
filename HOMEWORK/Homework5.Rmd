...
a. Let the random variable $X$ denote the number of Rh positive infants she needs to type before she finds the first positive case. Write the distribution of $X$. Be sure to state the values of any parameters. List the assumptions you need to make to answer this question.
